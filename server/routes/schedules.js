...
router.get("/summary", auth, async (req, res) => {
  try {
    ...
    const [totalSchedules, currentMonthSchedules, activeClasses, canceledClasses] =
      await Promise.all([
        ScheduledClass.countDocuments(), // total count
        ...
        ScheduledClass.countDocuments({ status: "scheduled" }),
        ScheduledClass.countDocuments({ status: "canceled" }),
      ]);
